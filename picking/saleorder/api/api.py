...
# local apps
from picking.saleorder.models import SaleOrder
from picking.saleorder.api.serializers import SaleOrderSerializer
from picking.saleorder.postgresql.conn import ConnSQLite3 as ConnDB
